// ESP32-C3 BLE NTP v0.12.6
// Changes from v0.12.6:
...
//   - Removed dead "nO" guard in syncNTP() -- setup() handles empty credentials
...
void startBLE() {
  ...
  pCharTX->setValue("FingerClock v0.12.6 ready");
